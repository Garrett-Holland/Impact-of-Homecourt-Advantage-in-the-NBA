...
```{r}
linear_regression_model <- lm(Win_Pct_Differential ~ Home_Vs_Away_Point_Differential + Elevation + Avg_Distance_Traveled_Against + Attendance_Pct, data = final_data)
